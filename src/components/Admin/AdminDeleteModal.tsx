        ...
        >
          ...
          >
            <motion.button
              ...
              onClick={onClose}
              disabled={isPending}
              className="px-4 py-2 rounded-md bg-gray-200 hover:bg-gray-300 text-gray-700 cursor-pointer transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Huỷ
            </motion.button>
            <motion.button
